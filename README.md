...
### 2.2.1 Autoencoder(AE)
 ...
 + (liu2022reconstruction)Reconstruction from edge image combined with color and gradient difference for industrial surface anomaly detection [[2022]](http://arxiv.org/pdf/2107.13118)
 ...
 + (hu2018squeeze)Squeeze-and-excitation networks [[2018]](http://arxiv.org/pdf/1709.01507)
...
### 2.2.3 Transformer
 ...
 + (vaswani2021scaling)Scaling local self-attention for parameter efficient visual backbones[[2021]](http://arxiv.org/pdf/2103.12731)
