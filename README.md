...
We discuss public datasets and related studies in detail. Welcome to read our paper and make comments. [Deep Industrial Image Anomaly Detection: A Survey](https://arxiv.org/abs/2301.11514)

We will keep focusing on this field and update relevant information. (Keywords: anomaly detection, anomaly segmentation, industrial image, defect detection. )
...
+ Anomalib: A Deep Learning Library for Anomaly Detection [[2022]](https://arxiv.org/abs/2202.08341)[[code]](https://github.com/openvinotoolkit/anomalib)
